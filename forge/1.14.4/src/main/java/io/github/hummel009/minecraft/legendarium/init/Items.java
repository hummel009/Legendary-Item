package io.github.hummel009.minecraft.legendarium.init;

import io.github.hummel009.minecraft.legendarium.item.ItemColdWeapon;
import io.github.hummel009.minecraft.legendarium.item.ItemGem;
...
public class Items {
	public static final DeferredRegister<Item> REGISTRY = new DeferredRegister<>(ForgeRegistries.ITEMS, "legendarium");
